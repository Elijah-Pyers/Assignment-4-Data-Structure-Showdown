...
#is exactly what a LIFO structure provides.
...
#cases. The stack approach easy to test, and minimizes additional thinking during the timer.
...
#reduce variety and keep tests clean within the time frame. I also wanted clarity over 
